...
<div class="content">
  <h3>首页 > 学科竞赛 > 编辑竞赛</h3>
  <div class="container">
    <form action="/vcm/compmana/save" method="post">
      <h1 style="text-align: center">编辑竞赛</h1>
      <label><b>请选择要编辑的竞赛</b></label>
      ...
      <input type="text" placeholder="请输入最大学生人数" name="studentNum">
      <label><b>最大指导队伍数量</b></label>
      <input type="text" placeholder="请输入教师最大指导队伍数量" name="teachMax" required>
      <input type="submit" value="保存修改" style="margin-left: 45%">
    </form>
  </div>
</div>
</body>
