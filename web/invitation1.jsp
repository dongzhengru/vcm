...
<div class="sidebar">
    ...
    <a href="/vcm/invitation1" class="menu-item" style="color: #007bff"><i class="fas fa-users"></i> 邀请查询</a>
...
<div class="content">
    <h3>首页 > 邀请查询</h3>
    <h1 style="text-align: center">收到的指导邀请</h1>
    <table>
        <thead>
        <tr>
            <th>邀请ID</th>
        ...
        <c:forEach items="${invitations}" var="invitation" varStatus="status">
            <tr>
                ...
                <td><a href="invitation1/accept?iid=${invitation.id}&tid=${invitation.team.tid}&cid=${invitation.team.cid}">同意</a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
