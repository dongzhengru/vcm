...
<div class="sidebar">
    ...
    <a href="/vcm/material" class="menu-item" style="color: #007bff"><i class="fa fa-upload"></i> 作品上传</a>
    <hr>
...
<div class="content">
    <h3>首页 > 作品上传</h3>
    <div class="container">
        <form action="material/submit" method="post">
            <h1 style="text-align: center">作品上传</h1>
            <label><b>请选择要上传作品的竞赛</b></label>
            <select name="cid" required class="comp_id">
                <c:forEach var="team" items="${teams}">
                    <option value="${team.cid}">${team.cname}</option>
                </c:forEach>
            </select>
            <label><b>网盘链接</b></label>
            <input type="text" placeholder="请输入网盘链接" name="murl" required>
            <label><b>网盘提取码</b></label>
            <input type="text" placeholder="请输入网盘提取码" name="mpwd" required>
            <input type="submit" value="上传作品" style="margin-left: 45%">
        </form>
    </div>
</div>
</body>
