...
<div class="sidebar">
    ...
    <a href="/vcm/teampass" class="menu-item" style="color: #007bff"><i class="fas fa-clipboard-check"></i> 队伍审核</a>
...
<div class="content">
    <h3>首页 > 队伍审核</h3>
    <h1 style="text-align: center">所有队伍</h1>
    <table>
        <thead>
        <tr>
            <th>序号</th>
        ...
        <c:forEach items="${teams}" var="team" varStatus="status">
            <tr>
                ...
                <td><a href="teampass/pass?tid=${team.tid}">通过</a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
